...
{
	eClientList = 1, eAddNewClient = 2, eDeleteClient = 3, eUpdateClientInfo = 4, eFindClient = 5,eTransactions = 6 , eExit = 7
};
...
void PrintClientRecordinBalanceLine(sClient Client)
{
	cout << "| ";
	SetWidthInCenter(15, Client.AccountNumber);
	cout << "| ";
...
void ShowTotalBalanceScreen()
{
	...
	cout << "\n" << Taps(4) << "Balance List (" << vClients.size() << ") Client(s).";
	...
	for (sClient Client : vClients)
	{
		PrintClientRecordinBalanceLine(Client);
		cout << endl;
	}
